...
std::ostream& operator<<(std::ostream& os, const Valuable& valuable) {return os << valuable.str();}
...
public:
    ...
    std::string str() const override {return fn::format("{}:{%.2f}:{}", label, value, volume);}
...
std::ostream& operator<<(std::ostream& os, const Coin& coin) {return os << coin.str();}
...
public:
    ...
    std::string str() const {return fn::format("{}:{%.2f}:{}", label, value, volume);}
...
std::ostream& operator<<(std::ostream& os, const Item& item) {return os << item.str();}
...
public:
    ...
    int getVolumeMax() const {return volumeMax;}
